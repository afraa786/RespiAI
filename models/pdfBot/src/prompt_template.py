...
class Prompts:
    ...
    def qa(self):
        system = (
            ...
            "If you don't know answer, just say you don't know, don't try to make up answer. Don't say you're an AI and can't provide solution or any other statement like that"
        )
